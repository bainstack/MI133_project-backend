...
app.post('/create_trip', (req, res) => {
    ...
    db.run('INSERT INTO trips (boat, latitude, longitude, departure, arrival) VALUES (?, ?, ?, ?, ?);', req.body.boat_id, req.body.latitude, req.body.longitude, req.body.departure, req.body.arrival, trip, (err, trip) => {
        if (err) {
